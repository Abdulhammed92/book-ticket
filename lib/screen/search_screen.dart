    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const AppIconText(icon: 
          Icons.flight_takeoff_rounded, text: "Departure"),
        ...
        Column(
          children: [
            Stack(
              ...
              AppLayout.getHeight(15),horizontal: AppLayout.getHeight(16)),
              child: Column(
                    ...
                    children: [
                      ...
                      style: Styles.headLineStyle2.copyWith(
                        ...
                        RichText(text: const TextSpan(
                          children: [
                            TextSpan(
                              text: "h",style: TextStyle(fontSize: 38)
                            ),
                            TextSpan(
